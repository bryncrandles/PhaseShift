...
for i = 1:n_SNR
    SNR = SNR_list(i)
    critical_value = parametric_pd_fourier(n_samples, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, n_burn);
    for j = 1:n_shift
        ...
        for k = 1:n_simulations
            ...
            [max_value, index] = max(abs(pd(phase)));
...
save power_anlaysis_fourier_pd frequency bandwidth SNR_list shift_list true_positive estimated_latency n_simulations
