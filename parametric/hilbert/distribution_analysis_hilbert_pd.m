...
[critical_value, observations] = parametric_pd(n_samples, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, 'hilbert', boundary);


save distribution_analysis_pd frequency bandwidth SNR n_bootstrap observations
