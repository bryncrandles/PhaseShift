function [critical_value, statistic] = parametric_pd_instant_ISI(n_samples, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, n_burn, shift_magnitude, ISI)
...
base_critical_value = parametric_pd_instant(n_samples, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, n_burn);
