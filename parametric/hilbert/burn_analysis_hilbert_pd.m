...
for i = 1:n_burn_parameters
    ...
    [critical_value, statistic] = parametric_pd_instant(signal_length, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, n_burn);    
    for j=1:n_shifts
...
save instant_burnSize_pd true_positives n_simulations burn_list shift_list alpha n_samples SNR bandwidth 

% Burn size is roughly 190 samples for PD and instant phase
