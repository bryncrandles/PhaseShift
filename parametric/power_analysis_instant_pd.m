...
for i = 1:n_SNR
    SNR = SNR_list(i)
    critical_value = parametric_pd_instant(n_samples, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, n_burn);
    for j = 1:n_shift
...
save power_anlaysis_instant_pd frequency bandwidth SNR_list shift_list true_positive estimated_latency n_simulations
