function [critical_value, statistic] = parametric_cusum_fourier_ISI(n_samples, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, n_burn, shift_magnitude, ISI)
...
base_critical_value = parametric_cusum_fourier(n_samples, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, n_burn);
