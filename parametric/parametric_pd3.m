function [critical_value_upper, statistics_upper] = parametric_pd3(n_samples, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, phase_type, boundary, shift_magnitude, shift_latency, upper_boundary, latency_tolerance)
...
% Adapted from "parametric_pd" and "parametric_pd2"
% INPUTS
