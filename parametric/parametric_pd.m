function [critical_value, statistic] = parametric_pd(n_samples, sampling_rate, SNR, frequency, bandwidth, alpha, n_bootstrap, phase_type, n_burn)
...
for boot = 1:n_bootstrap
    ...
    statistic(boot) = max(abs(pd(bootstrap_phase)));
end
